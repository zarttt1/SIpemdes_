...
<div class="dashboard-petugas">
    ...
    <div class="row mb-4 align-items-center">
        <div class="col-lg-8">
            ...
            <p class="mb-0">
                Selamat datang, 
                <strong>{{ optional(auth('petugas')->user())->nama ?? 'Petugas' }}</strong>
            </p>
        </div>
    </div>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-md-3">
            <div class="stat-card">
                ...
                <h3 class="text-info">{{ $pengaduanBaru ?? 0 }}</h3>
            </div>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="dashboard-header d-flex justify-content-between align-items-center">
            ...
            {{-- Sesuaikan rute --}}
            <a href="{{ route('petugas.pengaduan.index') }}" class="btn btn-sm btn-outline-light">
                Lihat Semua
            </a>
        </div>
    ...
    @forelse ($pengaduan ?? [] as $item)
        <tr>
            ...
            <td>{{ \Carbon\Carbon::parse($item->tanggal_pengaduan)->format('d M Y') }}</td>
