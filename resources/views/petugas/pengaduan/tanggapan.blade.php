...
<div class="container mt-4 response-container">
            ...
            <div class="message-box user-message shadow-sm">
                ...
                <div class="d-flex justify-content-between mb-2">
                    <strong class="text-danger">
                        {{ $pengaduan->masyarakat->nama ?? 'Pelapor' }}
                    </strong>
    ...
    @if($pengaduan->status != 'selesai')
        ...
        <div class="action-panel mt-4">
            ...
            <form action="{{ route('petugas.pengaduan.updateStatus', $pengaduan->id_pengaduan) }}" method="POST">
                ...
                {{-- Status otomatis berubah ke "proses" jika sebelumnya "menunggu" --}}
                <input type="hidden" name="status"
                       value="{{ $pengaduan->status == 'menunggu' ? 'proses' : $pengaduan->status }}">

                <div class="mb-2">
                    <label class="form-label fw-bold small text-muted text-uppercase">
                        Balasan Anda
                    </label>
                    <textarea name="isi_tanggapan" rows="3" class="form-control"
    ...
    @else
        ...
        <div class="alert alert-success text-center mt-4">
            ...
            Pengaduan ini telah diselesaikan.
        </div>
    @endif
